    ...
    <span>
      ...
      >
        ...
        <el-form-item
          label="收入"
          prop="money"
          :rules="[{ required: true, message: '请输入收入', trigger: 'blur' }]"
        >
